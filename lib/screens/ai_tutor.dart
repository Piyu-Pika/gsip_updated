                    ...
                    MaterialButton(
                        onPressed: () {
                          setState(() {
                            ...
                            modPrompt =
                                "act as a tutor and instated of providing the direct answer to the question provide me the steps to reach the answer and the question is $prompt";
                            gemini.text(modPrompt).then((value) =>
